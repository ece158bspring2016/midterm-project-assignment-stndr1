...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        //make the table's background color black
        ...
        //append todoitem to array
        toDoItems.append(ToDoItem(text: "finish midterm project"))
        toDoItems.append(ToDoItem(text: "study for finals"))
        toDoItems.append(ToDoItem(text: "become fiend"))
        toDoItems.append(ToDoItem(text: "cross up curry"))
        toDoItems.append(ToDoItem(text: "get some J-12's"))
        toDoItems.append(ToDoItem(text: "go to beach with family"))
        toDoItems.append(ToDoItem(text: "grow taller 2 inches "))
        toDoItems.append(ToDoItem(text: "create an iOS game"))
        toDoItems.append(ToDoItem(text: "get a hair cut"))
        toDoItems.append(ToDoItem(text: "get swoll"))
        toDoItems.append(ToDoItem(text: "get a summer job"))
        toDoItems.append(ToDoItem(text: "finish him"))
    }
    ...
    //create and populate table view cells
    ...
    //Creates color functionality
    func colorForIndex(index: Int) -> UIColor {
        //lower you go less intense the red is
